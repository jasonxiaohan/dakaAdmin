...
layui.define(['table', 'form','util'], function(exports){
  ...
  table.render({
    ...
    ,cols: [[
      ...
      // ,{title: '操作', width: 150, align:'center', fixed: 'right', toolbar: '#table-account-webuser'}
    ]]
    ,page: true
    ,limit: 30
    // ,height: 'full-320'
  ...
  table.render({
    ...
    ,cols: [[
      ...
      ,{title: '操作', width: 210, align: 'center', fixed: 'right', toolbar: '#table-account-admin'}
    ]]
  ...
  table.render({
    ...
    ,cols: [[
      ...
      ,{title: '操作', width: 150, align: 'center', fixed: 'right', toolbar: '#table-account-admin'}
    ]]
    ,text: {
        none: '暂无数据'
      }
